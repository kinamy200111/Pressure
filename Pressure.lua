    ...
    if painterFound then
        ...
        if not detectedMobs[painterKey] then
            ...
            if Settings.notificationsEnabled.Painter then
                ...
                print("Notification: Painter found!")
            end
            if WatermarkSystem then
...
local getCenterPosition; getCenterPosition = function()
    local camera = workspace.CurrentCamera
...
local FindKeycards; FindKeycards = function()
    local foundItems = {}
...
local CreateESP; CreateESP = function(item)
...
local StartKeycardESP; StartKeycardESP = function()
...
local CleanupKeycardESP; CleanupKeycardESP = function()
...
local ForceRescanESP; ForceRescanESP = function()
...
local FindDoors; FindDoors = function()
    local foundDoors = {}
    local gf = workspace:FindFirstChild("GameplayFolder")
...
local StartDoorESP; StartDoorESP = function()
...
local CleanupDoorESP; CleanupDoorESP = function()
...
-- Intelligent Border for ContentPageVisuals
...
-- Intelligent Border for ContentPageVisuals2
...
-- NoffiticationAnglerSwitch (Switch)
...
-- Switch NoffiticationAnglerSwitch
...
-- NoffiticationFrogerSwitch (Switch)
...
-- Switch NoffiticationFrogerSwitch
...
-- NoffiticationPinkieSwitch (Switch)
...
-- Switch NoffiticationPinkieSwitch
...
-- NoffiticationBlitzSwitch (Switch)
...
-- Switch NoffiticationBlitzSwitch
...
-- NoffiticationChainsmokerSwitch (Switch)
...
-- Switch NoffiticationChainsmokerSwitch
...
-- NoffiticationPandemoniumSwitch (Switch)
...
-- Switch NoffiticationPandemoniumSwitch
...
-- NoffiticationHarbingerSwitch (Switch)
...
-- Switch NoffiticationHarbingerSwitch
...
-- NoffiticationPainterRoomSwitch (Switch)
...
-- Switch NoffiticationPainterRoomSwitch
...
-- Intelligent Border for ContentPageVisuals3
...
-- Intelligent Border for ContentPageExploits
...
-- Intelligent Border for ContentPageMisc
...
-- AutoRescanSlider (Slider)

-- Slider AutoRescanSlider
...
-- Intelligent Border for ContentPageSettings
...
-- ToggleUIvisiblity (Keybind)

-- Keybind ToggleUIvisiblity
...
local Tab_ContentPageVisuals_SetVisible; Tab_ContentPageVisuals_SetVisible = function(visible)
...
local Tab_ContentPageVisuals2_SetVisible; Tab_ContentPageVisuals2_SetVisible = function(visible)
    if ContentPageVisuals2 then ContentPageVisuals2.Visible = visible end
    if ContentPageVisuals2_Border then ContentPageVisuals2_Border.Visible = visible end
end

local Tab_ContentPageVisuals3_SetVisible; Tab_ContentPageVisuals3_SetVisible = function(visible)
    if ContentPageVisuals3 then ContentPageVisuals3.Visible = visible end
    if ContentPageVisuals3_Border then ContentPageVisuals3_Border.Visible = visible end
end

local Tab_ContentPageExploits_SetVisible; Tab_ContentPageExploits_SetVisible = function(visible)
...
local Tab_ContentPageMisc_SetVisible; Tab_ContentPageMisc_SetVisible = function(visible)
...
local Tab_ContentPageSettings_SetVisible; Tab_ContentPageSettings_SetVisible = function(visible)
...
while true do
    ...
    if isrbxactive() then
        ...
        if mouse1 and not lastMouse1 then
            ...
            -- Button NoffiticationAnglerSwitch
            ...
            -- Button NoffiticationFrogerSwitch
            ...
            -- Button NoffiticationPinkieSwitch
            ...
            -- Button NoffiticationBlitzSwitch
            ...
            -- Button NoffiticationChainsmokerSwitch
            ...
            -- Button NoffiticationPandemoniumSwitch
            ...
            -- Button NoffiticationHarbingerSwitch
            ...
            -- Button NoffiticationPainterRoomSwitch
